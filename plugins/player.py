...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: PRINCE  (@DarkloverzS)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://te.legra.ph/file/505a08e45b6b2b31c2d96.png"
            ...
            [
                [
                        InlineKeyboardButton(
                            text="💥 REPO💞",
                            url=f"https://github.com/saurabhy20/Prince-Music-Player")
        ...
        try:
            ...
            [
                [
                        InlineKeyboardButton(
                            text="MUSIC-REPO",
                            url=f"https://t.me/PrinceVcSupport")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/505a08e45b6b2b31c2d96.png", 
                             caption="**💥 𝙋𝘼𝙐𝙎𝙀...**"
    )
...
async def resume(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/948d30591ef6cedacb99c.png", 
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("*ṔÉHĹÉ ǴÁŃÁ ĆHÁĹŰ ḰŔ PÁGĹÚ ...**")
    else:
